...
class AnnotationExtractor(ABC):
    ...
    def extract(self, path_to_file: str) -> list:
        """Extracts data for annotation from file
        Arguments:
            path_to_file: str
...
class ExtractorXML(AnnotationExtractor):
    def extract(self, path_to_file: str) -> list:
        """Extracts data for annotation from .xml file
        Arguments:
            path_to_file: str
                Absolute path to the .xml file
        Returns:
            Data from a file with an annotation in the form [[image_name, label, x_min, y_min, x_max, y_max], ...]
        """
        data_from_file = []
...
class ExtractorJSON(AnnotationExtractor):
    def extract(self, path_to_file: str) -> list:
        """Extracts data for annotation from .json file
        Arguments:
            path_to_file: str
...
class ExtractorCOCO(AnnotationExtractor):
    def extract(self, path_to_file: str) -> list:
        """Extracts data for annotation from .json file. ATTENTION: file .json structure is used for the dataset COCO
        Arguments:
            path_to_file: str
                Absolute path to the .json file
        Returns:
